...
export class UserController {
   static async update(c: Context) {
      try {
         ...
         const internshipStartDate = formData.get("internshipStartDate") as string;
         const internshipEndDate = formData.get("internshipEndDate") as string;
         const internshipPosition = formData.get("internshipPosition") as string;
         const internshipDivision = formData.get("internshipDivision") as string;
